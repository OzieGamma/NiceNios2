...
namespace Nios2Compiler.Test.Macros
{
    ...
    {
        private readonly IMacro macro = new Nios2Compiler.Macros.PushMacro();

        [TestMethod]
        public void MatchTest()
        {
            MacroHelper.ShouldMatch(this.macro, "push t1");
        }

        [TestMethod]
        public void InvalidMatchTest()
        {
            MacroHelper.ShouldNotMatch(this.macro, "pop t1");
        }
    }
}
